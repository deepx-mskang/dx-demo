...
struct AppArgs {
    std::string model = projectPath("assets/yolo26s.dxnn");
    std::string model_pose = projectPath("assets/yolo26s-pose.dxnn");
    std::string model_seg = projectPath("assets/yolo26s-seg.dxnn");
    std::string demo_image = projectPath("assets/yolo26-demo.png");
    std::string video;
