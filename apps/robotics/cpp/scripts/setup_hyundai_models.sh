...
# default value
SOURCE_PATH="res/assets/dx_demo_internal/hyundai_models.tar.gz"
...
main() {
    ...
    $GET_RES_CMD || {
        ...
        local hint_msg="If the issue persists, please try again with sudo and the --force option, like this: 'sudo ./setup_hyundai_models.sh --force'."
